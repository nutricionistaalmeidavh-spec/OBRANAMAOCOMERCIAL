...
export default function DocumentsPage() {
  ...
  return <>
    ...
    {view === 'pastas' ? <FileExplorer rootId="documents" rootLabel="Documentos" documentFeatures title="Pastas de documentos" description="Navegue, visualize, organize e digitalize arquivos dentro da área documental protegida do sistema."/> : <>
